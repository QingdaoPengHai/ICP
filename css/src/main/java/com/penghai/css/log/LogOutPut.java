...
public class LogOutPut {
	 ...
	 * @throws
	 */
	@Before(value = "execution(* com.penghai.css.*.controller..*.*(..))")
	...
	@Before(value = "execution(* com.penghai.css.*.business..*.*(..))")
	 ...
	 * @throws
	 */
	@After(value = "execution(* com.penghai.css.*.controller..*.*(..))")
	public void after(JoinPoint joinPoint) {
		Signature sig = joinPoint.getSignature();
		log.info("方法结束:" + sig.getDeclaringTypeName() + "." + sig.getName());
	}
	@After(value = "execution(* com.penghai.css.*.business..*.*(..))")
	 ...
	 * @throws
	 */
	@AfterThrowing(value = "execution(* com.penghai.css.*.controller..*.*(..))", throwing = "e")
	...
	@AfterThrowing(value = "execution(* com.penghai.css.*.business..*.*(..))", throwing = "e")
