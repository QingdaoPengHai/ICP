...
public class LogOutPut {
	 ...
	 * @throws
	 */
	@Before(value = "execution(* com.penghai.store.*.controller..*.*(..))")
	...
	@Before(value = "execution(* com.penghai.store.*.business..*.*(..))")
	 ...
	 * @throws
	 */
	@After(value = "execution(* com.penghai.store.*.controller..*.*(..))")
	public void after(JoinPoint joinPoint) {
		Signature sig = joinPoint.getSignature();
		log.info("方法结束:" + sig.getDeclaringTypeName() + "." + sig.getName());
	}
	@After(value = "execution(* com.penghai.store.*.business..*.*(..))")
	 ...
	 * @throws
	 */
	@AfterThrowing(value = "execution(* com.penghai.store.*.controller..*.*(..))", throwing = "e")
	...
	@AfterThrowing(value = "execution(* com.penghai.store.*.business..*.*(..))", throwing = "e")
