package com.penghai.testoficp.log;
...
public class LogOutPut {
	 ...
	 * @throws
	 */
	@Before(value = "execution(* com.penghai.testoficp.*.controller..*.*(..))")
	...
	@Before(value = "execution(* com.penghai.testoficp.*.business..*.*(..))")
	 ...
	 * @throws
	 */
	@After(value = "execution(* com.penghai.testoficp.*.controller..*.*(..))")
	public void after(JoinPoint joinPoint) {
		Signature sig = joinPoint.getSignature();
		log.info("方法结束:" + sig.getDeclaringTypeName() + "." + sig.getName());
	}
	@After(value = "execution(* com.penghai.testoficp.*.business..*.*(..))")
	 ...
	 * @throws
	 */
	@AfterThrowing(value = "execution(* com.penghai.testoficp.*.controller..*.*(..))", throwing = "e")
	...
	@AfterThrowing(value = "execution(* com.penghai.testoficp.*.business..*.*(..))", throwing = "e")
