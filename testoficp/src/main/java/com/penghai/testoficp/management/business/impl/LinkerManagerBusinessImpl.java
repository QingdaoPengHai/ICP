...
import com.penghai.testoficp.management.business.LinkerManagerBusiness;
...
import com.penghai.testoficp.util.CommonData.CM_LINKER_CONFIGURE;
import com.penghai.testoficp.util.CommonData.CM_LINKER_REDIS_PROPERTIES;
import com.penghai.testoficp.util.CommonData.CM_LINKER_RETURN_CODE;
...
public class LinkerManagerBusinessImpl implements LinkerManagerBusiness{
	...
	public String linkerRegister(String linkerId){
		...
		//linker有效
			...
			xmlTargetDatabase = goodsFileBusiness.getDatabaseInfoFromXml(linkerId);
			//解析xml文件失败
			if(xmlTargetDatabase == ""){
				logger.error("Failed to get target database info from getDatabaseInfoFromXml()");
